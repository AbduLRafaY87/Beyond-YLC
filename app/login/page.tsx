...
import { User, Mail, ArrowRight, Loader2, Eye, EyeOff, Sparkles, Shield, Users } from 'lucide-react'
          ...
          <div className="hidden lg:block space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full shadow-sm">
                ...
                <span className="text-sm font-semibold text-gray-700">Welcome to Beyond YLC</span>
              </div>
              ...
              <p className="text-xl text-gray-600 max-w-md">
                Join a vibrant community of learners and leaders shaping the future together.
              </p>
            </div>

            <div className="space-y-4 max-w-md">
              <div className="flex items-start gap-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl shadow-sm">
                <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Users className="w-5 h-5 text-purple-600" />
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Community First</h3>
                  <p className="text-sm text-gray-600">Connect with like-minded individuals and build lasting relationships</p>
                </div>
              </div>
